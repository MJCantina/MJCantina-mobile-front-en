...
class AppFonts {
  ...
  static final buttonText = GoogleFonts.poppins(fontSize: 16, color: AppColors.white, fontWeight: FontWeight.w800);
  static final payText = GoogleFonts.poppins(fontSize: 16, color: AppColors.primary, fontWeight: FontWeight.w800);
  static final profileDesc =  GoogleFonts.poppins(fontSize: 16, color: AppColors.grey, fontWeight: FontWeight.w800);
