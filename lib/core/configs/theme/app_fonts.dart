...
class AppFonts {
  ...
  static final buttonText = GoogleFonts.poppins(fontSize: 16, color: AppColors.white, fontWeight: FontWeight.w600);
  static final payText = GoogleFonts.poppins(fontSize: 16, color: AppColors.primary, fontWeight: FontWeight.w600);
  static final profileDesc =  GoogleFonts.poppins(fontSize: 16, color: AppColors.grey, fontWeight: FontWeight.w600);
